...
public class ClockFamiliar extends TrinketItem implements IAnimatable, TrinketRenderer {
    public AnimationFactory factory = new InstancedAnimationFactory(this);

    public ClockFamiliar(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.thesewers.clockfamtp").formatted(Formatting.YELLOW));
