...
public class SuspiciousEyeFamiliar extends TrinketItem implements IAnimatable, TrinketRenderer {
    public AnimationFactory factory = new InstancedAnimationFactory(this);

    public SuspiciousEyeFamiliar(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.thesewers.eyefamtp").formatted(Formatting.LIGHT_PURPLE));
